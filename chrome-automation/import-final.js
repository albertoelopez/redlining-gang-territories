...
async function main() {
  ...
  console.log('Import Remaining Gang Territories');
  console.log('='.repeat(50));
  ...
  // Group 1: Inglewood & South LA East
  await importFile(
    page,
    path.join(KML_DIR, 'la_gangs_inglewood_south.kml'),
    'Inglewood & South LA East'
  );

  await sleep(3000);

  // Group 2: Compton & Long Beach
  await importFile(
    page,
    path.join(KML_DIR, 'la_gangs_compton_lb.kml'),
    'Compton & Long Beach'
  );

  console.log('\n' + '='.repeat(50));
  console.log('Done! Your LA map is complete.');
  console.log('='.repeat(50));
