...
async function main() {
  ...
  console.log('Import LA All HOLC Grades + Gang Territories');
  console.log('='.repeat(50));
  ...
  // Import all HOLC grades
  await importFile(
    page,
    path.join(KML_DIR, 'los_angeles_grade_A.kml'),
    'LA Grade A - Best (1939)'
  );
  ...
  await importFile(
    page,
    path.join(KML_DIR, 'los_angeles_grade_B.kml'),
    'LA Grade B - Desirable (1939)'
  );
  ...
  await importFile(
    page,
    path.join(KML_DIR, 'los_angeles_grade_C.kml'),
    'LA Grade C - Declining (1939)'
  );
  ...
  await importFile(
    page,
    path.join(KML_DIR, 'los_angeles_grade_D.kml'),
    'LA Grade D - Redlined (1939)'
  );

  await sleep(3000);

  // Import LA Gang Territories (all regions)
  await importFile(
    page,
    path.join(KML_DIR, 'la_gang_territories.kml'),
    'LA Gang Territories'
  );
